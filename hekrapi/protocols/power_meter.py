...
PROTOCOL = RawProtocol(
    ...
    Command(11, FrameType.RECEIVE, "reportData", arguments=[
        ...
        Argument("voltage_1", TO_FLOAT, 2, "U1", multiplier=0.1, value_min=0, value_max=999.9),
        Argument("voltage_2", TO_FLOAT, 2, "U2", multiplier=0.1, value_min=0, value_max=999.9),
        Argument("voltage_3", TO_FLOAT, 2, "U3", multiplier=0.1, value_min=0, value_max=999.9),
